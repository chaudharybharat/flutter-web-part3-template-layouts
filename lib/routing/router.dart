...
import 'package:the_basics/views/secondpage/second_page_view.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case SecondPage:
      return _getPageRoute(SecondPageView(), settings.name);
    case ThirdScreenName:
      return _getPageRoute(ThirdScreenView(), settings.name);
